                    ...
                    <TableCell className="text-right">
                      <div className="flex gap-1 justify-end">
                        {conta.situacao === 'ABERTA' && (
                          <Button variant="ghost" size="sm" title="Baixar conta a pagar" onClick={() => handleBaixar(conta.id)}>
                            <CheckCircle className="h-4 w-4 text-green-600" />
                          </Button>
                        )}
                        {conta.situacao !== 'PAGO' && (
                          <Button variant="ghost" size="sm" title="Excluir conta a pagar" onClick={() => handleExcluir(conta.id)}>
